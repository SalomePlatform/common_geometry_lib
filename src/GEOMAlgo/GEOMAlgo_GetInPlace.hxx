                             ...
                             public GEOMAlgo_Algo
{
 public:
  ...
  Standard_EXPORT
    GEOMAlgo_GetInPlace();
  /**
   * Constructor with values, it initializes objects and
   * other necessary parameters and performs the operation.
   */
  Standard_EXPORT
    GEOMAlgo_GetInPlace(const TopoDS_Shape &theWhere,
